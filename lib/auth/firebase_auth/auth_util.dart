...
DocumentReference? get currentUserReference =>
    loggedIn ? UserStudentRecord.collection.doc(currentUser!.uid) : null;

UserStudentRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserStudentRecord.getDocument(UserStudentRecord.collection.doc(uid))
              .handleError((_) {}),
    )
