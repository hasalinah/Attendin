...
class _AddTeacherWidgetState extends State<AddTeacherWidget>
  ...
  void initState() {
    ...
    _model.studentemailController ??= TextEditingController();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          ...
          onTap: () async {
            logFirebaseEvent('ADD_TEACHER_PAGE_Icon_objuozy4_ON_TAP');
      ...
      body: SafeArea(
        top: true,
        child: StreamBuilder<List<UserStudentRecord>>(
          stream: queryUserStudentRecord(
            singleRecord: true,
          ),
          builder: (context, snapshot) {
            ...
            List<UserStudentRecord> columnUserStudentRecordList =
                snapshot.data!;
            // Return an empty Container when the item does not exist.
            if (snapshot.data!.isEmpty) {
              return Container();
            }
            final columnUserStudentRecord =
                columnUserStudentRecordList.isNotEmpty
                    ? columnUserStudentRecordList.first
                    : null;
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
                    child: TextFormField(
                      controller: _model.studentemailController,
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'Email ',
                        labelStyle: FlutterFlowTheme.of(context).bodySmall,
                      ...
                      validator: _model.studentemailControllerValidator
                          .asValidator(context),
                    ),
                  ),
                  Padding(
                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<List<UserStudentRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<UserStudentRecord> buttonUserStudentRecordList =
                              snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          }
                          final buttonUserStudentRecord =
                              buttonUserStudentRecordList.isNotEmpty
                                  ? buttonUserStudentRecordList.first
                                  : null;
                          return FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'ADD_TEACHER_COMPLETE_ACCOUNT_BTN_ON_TAP');
