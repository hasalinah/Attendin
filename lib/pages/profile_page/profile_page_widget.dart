                ...
                child: Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('PROFILE_Container_4wk6f6r7_ON_TAP');
                        logFirebaseEvent('Container_navigate_to');

                        context.pushNamed('addCRN');
                      },
                      child: Material(
                ...
                child: Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('PROFILE_Container_21wrph53_ON_TAP');
                        logFirebaseEvent('Container_navigate_to');
                ...
                child: Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('PROFILE_Container_2hnay5vx_ON_TAP');
                        logFirebaseEvent('Container_navigate_to');
